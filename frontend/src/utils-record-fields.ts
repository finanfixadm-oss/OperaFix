...
export const recordColumns: RecordColumnDefinition[] = [
  ...
  { field: "grupo_empresa", label: "Holding / Grupo empresa", type: "text", defaultVisible: true, value: (r) => r.grupo_empresa || r.group?.name },
  ...
  { field: "monto_devolucion", label: "Monto estimado", type: "number", defaultVisible: true, money: true, value: (r) => r.monto_devolucion },
  ...
  { field: "confirmacion_poder", label: "Confirmación Poder Notarial", type: "boolean", value: (r) => r.confirmacion_poder },
  { field: "acceso_portal", label: "Acceso portal", type: "text", value: (r) => r.acceso_portal },
  { field: "porcentaje_liquidaciones", label: "Porcentaje de liquidaciones", type: "text", value: (r) => r.porcentaje_liquidaciones },
  ...
  { field: "monto_cliente", label: "Monto estimado cliente", type: "number", money: true, value: (r) => r.monto_cliente },
