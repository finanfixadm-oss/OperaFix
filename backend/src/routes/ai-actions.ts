...
const REPORT_COLUMNS: ReportColumn[] = [
  ...
  { key: "grupo_empresa", label: "Holding / Grupo empresa", aliases: ["holding", "grupo", "grupo empresa"] },
  { key: "mes_produccion_2026", label: "Mes producción", aliases: ["mes produccion", "mes producción"] },
  { key: "monto_devolucion", label: "Monto estimado", type: "money", aliases: ["monto estimado", "monto", "devolucion", "devolución"] },
  { key: "monto_cliente", label: "Monto estimado cliente", type: "money", aliases: ["monto estimado cliente", "cliente monto"] },
  { key: "porcentaje_liquidaciones", label: "Porcentaje de liquidaciones", aliases: ["porcentaje liquidaciones"] },
